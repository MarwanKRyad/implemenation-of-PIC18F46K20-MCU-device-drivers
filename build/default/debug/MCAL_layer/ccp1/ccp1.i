...
# 11 "MCAL_layer/ccp1/ccp1.h"
# 1 "MCAL_layer/ccp1/ccp1_cfg.h" 1
# 11 "MCAL_layer/ccp1/ccp1.h" 2
...
# 11 "MCAL_layer/ccp1/../MCAL_std_types.h"
# 1 "MCAL_layer/ccp1/../std_lib.h" 1
# 11 "MCAL_layer/ccp1/../std_lib.h"
...
# 11 "MCAL_layer/ccp1/../std_lib.h" 2
...
# 12 "MCAL_layer/ccp1/../std_lib.h" 2
...
# 14 "MCAL_layer/ccp1/../std_lib.h" 2
# 11 "MCAL_layer/ccp1/../MCAL_std_types.h" 2
...
# 10 "MCAL_layer/ccp1/../interrupt/internal_interrupt.h"
# 1 "MCAL_layer/ccp1/../interrupt/interrupt_config.h" 1
# 14 "MCAL_layer/ccp1/../interrupt/interrupt_config.h"
# 1 "MCAL_layer/ccp1/../interrupt/interrupt_gen_conf.h" 1
# 14 "MCAL_layer/ccp1/../interrupt/interrupt_config.h" 2

# 1 "MCAL_layer/ccp1/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h" 1
# 13 "MCAL_layer/ccp1/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h"
# 1 "MCAL_layer/ccp1/../interrupt/../../MCAL_layer/GPIO/../device_config.h" 1
# 13 "MCAL_layer/ccp1/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h" 2
...
# 15 "MCAL_layer/ccp1/../interrupt/interrupt_config.h" 2
...
# 10 "MCAL_layer/ccp1/../interrupt/internal_interrupt.h" 2
# 15 "MCAL_layer/ccp1/ccp1.h" 2
# 44 "MCAL_layer/ccp1/ccp1.h"
typedef union
{
    struct {
    uint8 stcut_low;
...
static void (* ccp1_call) (void)=((void*)0);
static void (* ccp2_call) (void)=((void*)0);
...
# 41 "MCAL_layer/ccp1/ccp1.c"
Std_ReturnType ccp_init(ccp_t * my_ccp)
{ Std_ReturnType ret=(Std_ReturnType) 0x0;

if(my_ccp->ccp_number==1)
{
(CCP1CONbits.CCP1M=my_ccp->ccp_detailed_mode);

}
else if(my_ccp->ccp_number==2)
{
(CCP2CONbits.CCP2M=my_ccp->ccp_detailed_mode);
...
if(my_ccp->ccp_mode_==1)
{

    PR2=(uint8)(( 8000000 /( my_ccp->postscaler_value * 4.0 * my_ccp->prescaler_value * my_ccp->pwm_freq_ ))-1);
}


else if(my_ccp->ccp_mode_==2)
{
ccp_select_timer_(my_ccp);
}


else if(my_ccp->ccp_mode_==3)
{
ccp_select_timer_(my_ccp);
