...
# 11 "MCAL_layer/timer3/../MCAL_std_types.h"
# 1 "MCAL_layer/timer3/../std_lib.h" 1
# 11 "MCAL_layer/timer3/../std_lib.h"
...
# 11 "MCAL_layer/timer3/../std_lib.h" 2
...
# 12 "MCAL_layer/timer3/../std_lib.h" 2
...
# 14 "MCAL_layer/timer3/../std_lib.h" 2
# 11 "MCAL_layer/timer3/../MCAL_std_types.h" 2
...
# 10 "MCAL_layer/timer3/../interrupt/internal_interrupt.h"
# 1 "MCAL_layer/timer3/../interrupt/interrupt_config.h" 1
# 14 "MCAL_layer/timer3/../interrupt/interrupt_config.h"
# 1 "MCAL_layer/timer3/../interrupt/interrupt_gen_conf.h" 1
# 14 "MCAL_layer/timer3/../interrupt/interrupt_config.h" 2

# 1 "MCAL_layer/timer3/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h" 1
# 13 "MCAL_layer/timer3/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h"
# 1 "MCAL_layer/timer3/../interrupt/../../MCAL_layer/GPIO/../device_config.h" 1
# 13 "MCAL_layer/timer3/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h" 2
...
# 15 "MCAL_layer/timer3/../interrupt/interrupt_config.h" 2
...
# 10 "MCAL_layer/timer3/../interrupt/internal_interrupt.h" 2
...
{
    if(my_timer3->timer3_mode==1)
    {
        ( T3CONbits.TMR3CS=1);
         if(my_timer3->counter_mode==1)
         {
             (T3CONbits.T3SYNC=0);
         }
         else
...
Std_ReturnType timer3_init(timer3_t *my_timer3)
{
  ...
  ret=(PIR2bits.TMR3IF=0);
        ...
        ret= (PIE2bits.TMR3IE=1);




(T3CONbits.T3CKPS=my_timer3->prescaler_value);
