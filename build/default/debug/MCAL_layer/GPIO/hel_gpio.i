...
# 2 "<built-in>" 2
# 1 "MCAL_layer/GPIO/hel_gpio.c" 2
...
# 11 "MCAL_layer/GPIO/../std_lib.h" 2
...
# 12 "MCAL_layer/GPIO/../std_lib.h" 2
...
# 14 "MCAL_layer/GPIO/../std_lib.h" 2
...
{ Std_ReturnType ret=(Std_ReturnType) 0x1;
    ...
    if(my_config==((void*)0)|| (my_config->my_pin > 8 -1) || (my_config->my_port > 5 -1) )
    {
        ...
        {
          case OUTPUT:
                (*TRIS_REG[my_config->my_port] &=~(1<<my_config->my_pin));
...
Std_ReturnType gio_pin_read_direction(pin_config* my_config,uint8* direc )
{
     ...
     if(my_config==((void*)0)|| (my_config->my_pin > 8 -1) || (my_config->my_port > 5 -1) )
    {
      ...
      *direc= ((*TRIS_REG[my_config->my_port] >>my_config->my_pin )&1);
...
{ Std_ReturnType ret=(Std_ReturnType) 0x1;
     if(my_config==((void*)0)|| (my_config->my_pin > 8 -1) || (my_config->my_port > 5 -1) )
    {
        ...
        {
          case HIGH:
                (*LAT_REG[my_config->my_port] |=(1<<my_config->my_pin));
...
Std_ReturnType ret=(Std_ReturnType) 0x1;
     if(my_config==((void*)0)|| (my_config->my_pin > 8 -1) || (my_config->my_port > 5 -1) )
    {
      ...
      *logic= ((*PORT_REG[my_config->my_port] >>my_config->my_pin )&1);
...
# 117 "MCAL_layer/GPIO/hel_gpio.c"
Std_ReturnType gio_pin_init(pin_config* my_config)
{
Std_ReturnType ret=(Std_ReturnType) 0x1;
