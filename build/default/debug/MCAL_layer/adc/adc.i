...
# 10 "MCAL_layer/adc/../interrupt/internal_interrupt.h"
# 1 "MCAL_layer/adc/../interrupt/interrupt_config.h" 1
# 14 "MCAL_layer/adc/../interrupt/interrupt_config.h"
# 1 "MCAL_layer/adc/../interrupt/interrupt_gen_conf.h" 1
# 14 "MCAL_layer/adc/../interrupt/interrupt_config.h" 2

# 1 "MCAL_layer/adc/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h" 1
# 13 "MCAL_layer/adc/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h"
# 1 "MCAL_layer/adc/../interrupt/../../MCAL_layer/GPIO/../device_config.h" 1
# 13 "MCAL_layer/adc/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h" 2
...
# 10 "MCAL_layer/adc/../interrupt/internal_interrupt.h" 2
# 13 "MCAL_layer/adc/adc.h" 2
# 63 "MCAL_layer/adc/adc.h"
typedef enum
{
    channel_a0,
    channel_a1,
...
static void (* adc_call) (void)=((void*)0);
static Std_ReturnType adc_input_pin(uint8 my_pin)
{

    switch(my_pin)
    { case(channel_a0): (TRISA |=(1<<0x0)); break;
             case(channel_a1): (TRISA |=(1<<0x1));break;
             case(channel_a2): (TRISA |=(1<<0x2));break;
             case(channel_a3): (TRISA |=(1<<0x3));break;
             case(channel_a4): (TRISA |=(1<<0x5));break;

             case(channel_a5): (TRISE |=(1<<0x0));break;
             case(channel_a6): (TRISE |=(1<<0x1));break;
              case(channel_a7): (TRISE |=(1<<0x2));break;
                            case(channel_a8): (TRISB |=(1<<0x2));break;
                            case(channel_a9): (TRISB |=(1<<0x3));break;
                            case(channel_a10): (TRISB |=(1<<0x1));break;
                            case(channel_a11): (TRISB |=(1<<0x4));break;
                            case(channel_a12): (TRISB |=(1<<0x0));break;}
...
Std_ReturnType adc_init(adc_pin_t * my_adc)
{
 ...
 (ADCON2bits.ACQT=my_adc->pin_time) ;
 (ADCON2bits.ADCS=my_adc->pin_clock) ;
 (ADCON0bits.CHS=my_adc->pin_name);
...
Std_ReturnType adc_is_conv_end(adc_pin_t * my_adc ,uint8* my_ans)
   ...
   Std_ReturnType ret=(Std_ReturnType) 0x0;
    ...
    if( my_adc == ((void*)0) || my_ans==((void*)0) )
    {
        ret=(Std_ReturnType) 0x0;
    }
    else
    { if((ADCON0bits.GO_nDONE)==0) {*my_ans=1;}
    else
    {
        *my_ans=0;
    }
