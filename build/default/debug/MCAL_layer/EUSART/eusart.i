...
# 10 "MCAL_layer/EUSART/EUSART.h" 2


# 1 "MCAL_layer/EUSART/../MCAL_std_types.h" 1
# 11 "MCAL_layer/EUSART/../MCAL_std_types.h"
# 1 "MCAL_layer/EUSART/../std_lib.h" 1
# 11 "MCAL_layer/EUSART/../std_lib.h"
...
# 11 "MCAL_layer/EUSART/../std_lib.h" 2
...
# 12 "MCAL_layer/EUSART/../std_lib.h" 2
...
# 14 "MCAL_layer/EUSART/../std_lib.h" 2
# 11 "MCAL_layer/EUSART/../MCAL_std_types.h" 2

# 1 "MCAL_layer/EUSART/../compiler.h" 1
# 12 "MCAL_layer/EUSART/../MCAL_std_types.h" 2
...
# 1 "MCAL_layer/EUSART/../interrupt/internal_interrupt.h" 1
# 10 "MCAL_layer/EUSART/../interrupt/internal_interrupt.h"
# 1 "MCAL_layer/EUSART/../interrupt/interrupt_config.h" 1
# 14 "MCAL_layer/EUSART/../interrupt/interrupt_config.h"
# 1 "MCAL_layer/EUSART/../interrupt/interrupt_gen_conf.h" 1
# 14 "MCAL_layer/EUSART/../interrupt/interrupt_config.h" 2

# 1 "MCAL_layer/EUSART/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h" 1
# 13 "MCAL_layer/EUSART/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h"
# 1 "MCAL_layer/EUSART/../interrupt/../../MCAL_layer/GPIO/../device_config.h" 1
# 13 "MCAL_layer/EUSART/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h" 2
...
# 15 "MCAL_layer/EUSART/../interrupt/interrupt_config.h" 2
...
# 10 "MCAL_layer/EUSART/../interrupt/internal_interrupt.h" 2
# 13 "MCAL_layer/EUSART/EUSART.h" 2
# 64 "MCAL_layer/EUSART/EUSART.h"
  typedef enum {
...
static void (* tx_call) (void)=((void*)0);
static void (* rx_call) (void)=((void*)0);
...
Std_ReturnType eusart_rx_read_byte_blocking(uint8 *val)
   {
       Std_ReturnType ret = (Std_ReturnType) 0x0;
    while(!PIR1bits.RCIF);
...
void baud_rate_calc(eusart_t * eusart)
{
    ...
    {case _8BIT_Asynchronous_low :
        TXSTAbits.SYNC=0;
           TXSTAbits.BRGH=0;
           BAUDCONbits.BRG16=0;
           temp=((8000000/(float)eusart->baudrate )/64)-1;
            break;
    ...
    case _8BIT_Asynchronous_high :
        TXSTAbits.SYNC=0;
           TXSTAbits.BRGH=1;
           BAUDCONbits.BRG16=0;
                       temp=((8000000/(float)eusart->baudrate )/16)-1;
    ...
    case _16BIT_Asynchronous_high :
        TXSTAbits.SYNC=0;
           TXSTAbits.BRGH=1;
           BAUDCONbits.BRG16=1;
     temp=((8000000/(float)eusart->baudrate )/4)-1;
...
void tx_mode_init(eusart_t * eusart)
{
    if(eusart->tx_config.tx_enable==1)
    {
    TXSTAbits.TXEN=1;

       if(eusart->tx_config.tx_9_8_bit==1)
            {
                TXSTAbits.TX9=1;
            }
       else
...
void rx_mode_init(eusart_t * eusart)
{
    if(eusart->rx_config.rx_enable==1)
    {
    RCSTAbits.CREN=1;

       if(eusart->rx_config.rx_9_8_bit==1)
            {
                 RCSTAbits.RX9=1;
            }
       else
