...
# 11 "MCAL_layer/timer1/../MCAL_std_types.h"
# 1 "MCAL_layer/timer1/../std_lib.h" 1
# 11 "MCAL_layer/timer1/../std_lib.h"
...
# 11 "MCAL_layer/timer1/../std_lib.h" 2
...
# 12 "MCAL_layer/timer1/../std_lib.h" 2
...
# 14 "MCAL_layer/timer1/../std_lib.h" 2
# 11 "MCAL_layer/timer1/../MCAL_std_types.h" 2
...
# 10 "MCAL_layer/timer1/../interrupt/internal_interrupt.h"
# 1 "MCAL_layer/timer1/../interrupt/interrupt_config.h" 1
# 14 "MCAL_layer/timer1/../interrupt/interrupt_config.h"
# 1 "MCAL_layer/timer1/../interrupt/interrupt_gen_conf.h" 1
# 14 "MCAL_layer/timer1/../interrupt/interrupt_config.h" 2

# 1 "MCAL_layer/timer1/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h" 1
# 13 "MCAL_layer/timer1/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h"
# 1 "MCAL_layer/timer1/../interrupt/../../MCAL_layer/GPIO/../device_config.h" 1
# 13 "MCAL_layer/timer1/../interrupt/../../MCAL_layer/GPIO/hal_gpio.h" 2
...
# 15 "MCAL_layer/timer1/../interrupt/interrupt_config.h" 2
...
# 10 "MCAL_layer/timer1/../interrupt/internal_interrupt.h" 2
...
{
    if(my_timer1->timer1_mode==1)
    {
        ( T1CONbits.TMR1CS=1);
         if(my_timer1->counter_mode==1)
         {
             (T1CONbits.T1SYNC=0);
         }
         else
...
Std_ReturnType timer1_init(timer1_t *my_timer1)
{
  ...
  ret=(PIR1bits.TMR1IF=0);
        ...
        ret= (PIE1bits.TMR1IE=1);




(T1CONbits.T1CKPS=my_timer1->prescaler_value);
timer1_mode(my_timer1);
timer1_register_size(my_timer1);

if(my_timer1->timer1_osc_enable==1)
{
(T1CONbits.T1OSCEN=1);
}
else
