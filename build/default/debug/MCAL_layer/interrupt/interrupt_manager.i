...
void __attribute__((picinterrupt(("")))) interrupt_high()

{
    ...
    if((PORTBbits.KBI0==1)&&(1==INTCONbits.RBIE)
            &&(1==INTCONbits.RBIF)&&(flag_4==1))
        {RB4_ISR();
         flag_4=0;
        }
    else {}
   if((PORTBbits.KBI0==0)&&(1==INTCONbits.RBIE)
           &&(1==INTCONbits.RBIF)&&(flag_4==0))
        {RB4_ISR2();
        flag_4=1;
        }

     if((PORTBbits.KBI1==1)&&(1==INTCONbits.RBIE)
             &&(1==INTCONbits.RBIF)&&(flag_5==1))
        {RB5_ISR();
         flag_5=0;
        }
    else {}
   if((PORTBbits.KBI1==0)&&(1==INTCONbits.RBIE)
           &&(1==INTCONbits.RBIF)&&(flag_5==0))
        {RB5_ISR2();
        flag_5=1;
        }
    else {}

      if((PORTBbits.KBI2==1)&&(1==INTCONbits.RBIE)
            &&(1==INTCONbits.RBIF)&&(flag_6==1))
        {RB6_ISR();
         flag_6=0;
        }
    else {}
   if((PORTBbits.KBI2==0)&&(1==INTCONbits.RBIE)
           &&(1==INTCONbits.RBIF)&&(flag_6==0))
        {RB6_ISR2();
        flag_6=1;
        }

     if((PORTBbits.KBI3==1)&&(1==INTCONbits.RBIE)
             &&(1==INTCONbits.RBIF)&&(flag_7==1))
        {RB7_ISR();
         flag_7=0;
        }
    else {}
   if((PORTBbits.KBI3==0)&&(1==INTCONbits.RBIE)
           &&(1==INTCONbits.RBIF)&&(flag_7==0))
        {RB7_ISR2();
        flag_7=1;
        }
    else {}
...
void __attribute__((picinterrupt(("low_priority")))) interrupt_low(void)
{
    if((1==INTCON3bits.INT2E)&&(1==INTCON3bits.INT2F))
        {INT2_ISR();}
    else {}
