...
# 11 "MCAL_layer/interrupt/../std_lib.h"
...
# 11 "MCAL_layer/interrupt/../std_lib.h" 2
...
# 12 "MCAL_layer/interrupt/../std_lib.h" 2
...
# 14 "MCAL_layer/interrupt/../std_lib.h" 2
...
# 1 "MCAL_layer/interrupt/interrupt_gen_conf.h" 1
...
# 15 "MCAL_layer/interrupt/interrupt_config.h" 2
...
# 54 "MCAL_layer/interrupt/external_interrupt.h"
typedef enum{
...
static void (* int0_call) (void)=((void*)0);
static void (* int1_call) (void)=((void*)0);
static void (* int2_call) (void)=((void*)0);

static void (* rb4_call_high) (void)=((void*)0);
static void (* rb4_call_low) (void)=((void*)0);

static void (* rb5_call_high) (void)=((void*)0);
static void (* rb5_call_low) (void)=((void*)0);

static void (* rb6_call_high) (void)=((void*)0);
static void (* rb6_call_low) (void)=((void*)0);

static void (* rb7_call_high) (void)=((void*)0);
static void (* rb7_call_low) (void)=((void*)0);



static Std_ReturnType INTERRUPT_INTX_call_back(INTX_T * my_int)
{
        Std_ReturnType ret=(Std_ReturnType) 0x1;
     if(my_int==((void*)0) )
    {
        ret=(Std_ReturnType) 0x0;
    }
    else
    {
...
Std_ReturnType ret=(Std_ReturnType) 0x1;
    ...
    else
    {
        ...
        (INTCONbits.GIEL=1);}
         ...
         switch(my_int->source)
         {
             case Int0 :(INTCONbits.INT0IE=1);
                 break;
             case Int1 :(INTCON3bits.INT1IE=1);
                 break;

             case Int2 :(INTCON3bits.INT2IE=1);
                 break;
         }
...
Std_ReturnType ret=(Std_ReturnType) 0x1;
    ...
    else
    {
         switch(my_int->source)
         {
             case Int0 :(INTCONbits.INT0IE=0);
                 break;
             case Int1 :(INTCON3bits.INT1IE=0);
                 break;

             case Int2 :(INTCON3bits.INT2IE=0);
                 break;
         }
     ...
     if(my_int->source==INT0)
        {
            switch(my_int->source)
                {
                 case Rising_edge :(INTCON2bits.INTEDG0=1);
                     break;
                 case Falling_edge :(INTCON2bits.INTEDG0=0);
                     break;
                }
    ...
    else if(my_int->source==INT1)
        {
             switch(my_int->source)
                {
                 case Rising_edge :(INTCON2bits.INTEDG1=1);
                     break;
                 case Falling_edge :(INTCON2bits.INTEDG1=0);
                     break;
                }
    ...
    else if(my_int->source==INT2)
            {
                switch(my_int->source)
                {
                 case Rising_edge :(INTCON2bits.INTEDG2=1);
                     break;
                 case Falling_edge :(INTCON2bits.INTEDG2=0);
                     break;
                }
    ...
    { if(my_int->source==Int1)
            {
                ...
                {
                 case Low_Priority :(INTCON3bits.INT1IP=0);
                     break;
                 case High_Priority :(INTCON3bits.INT1IP=1);
                     break;
                }
    ...
    else if(my_int->source==Int2)
            {
                switch(my_int->priority)
                {
                 case Low_Priority :(INTCON3bits.INT2IP=0);
                     break;
                 case High_Priority :(INTCON3bits.INT2IP=1);
                     break;
                }
...
Std_ReturnType ret=(Std_ReturnType) 0x1;
    ...
    else
    {
         switch(my_int->source)
         {
             case Int0 :(INTCONbits.INT0IF=0);
                 break;
             case Int1 :(INTCON3bits.INT1IF=0);
                 break;

             case Int2 :(INTCON3bits.INT2IF=0);
                 break;
         }
