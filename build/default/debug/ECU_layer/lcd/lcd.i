...
# 11 "ECU_layer/lcd/../../MCAL_layer/GPIO/../std_lib.h"
...
# 11 "ECU_layer/lcd/../../MCAL_layer/GPIO/../std_lib.h" 2
...
# 12 "ECU_layer/lcd/../../MCAL_layer/GPIO/../std_lib.h" 2
...
# 14 "ECU_layer/lcd/../../MCAL_layer/GPIO/../std_lib.h" 2
...
# 10 "ECU_layer/lcd/lcd.h" 2
# 30 "ECU_layer/lcd/lcd.h"
typedef struct
{
    pin_config lcd_rs;
    pin_config lcd_e;
...
{ Std_ReturnType ret=(Std_ReturnType) 0x1;
    ...
    else
    {
        ...
        _delay((unsigned long)((0.5)*(8000000/4000.0)));
...
Std_ReturnType lcd_4bit_initilization(lcd_4 * my_lcd)
 ...
 Std_ReturnType ret=(Std_ReturnType) 0x1;
    ...
    { ret=gio_pin_init(&(my_lcd->lcd_rs));
        ...
        ret=lcd_4bit_sned_command(my_lcd,0X38);
        ...
        ret=lcd_4bit_sned_command(my_lcd,0X1);
_delay((unsigned long)((200)*(8000000/4000.0)));
                                               ret=lcd_4bit_sned_command(my_lcd,0X28);

        ret=lcd_4bit_sned_command(my_lcd,0X2);

        ret=lcd_4bit_sned_command(my_lcd,0X6);

        ret=lcd_4bit_sned_command(my_lcd,0X0C);

        ret=lcd_4bit_sned_command(my_lcd,0X80);
# 131 "ECU_layer/lcd/lcd.c"
    }
return ret;
...
Std_ReturnType lcd_8bit_initilization(lcd_8 * my_lcd)
 ...
 Std_ReturnType ret=(Std_ReturnType) 0x1;
    ...
    else
    {
        ...
        ret=gio_pin_init(&(my_lcd->lcd_e));
         _delay((unsigned long)((200)*(8000000/4000.0)));
        ret=lcd_8bit_sned_command(my_lcd,0X38);
         _delay((unsigned long)((5)*(8000000/4000.0)));
        ret=lcd_8bit_sned_command(my_lcd,0X38);

           _delay((unsigned long)((120)*(8000000/4000000.0)));
        ret=lcd_8bit_sned_command(my_lcd,0X1);
        ret=lcd_8bit_sned_command(my_lcd,0X2);
        ret=lcd_8bit_sned_command(my_lcd,0X6);
        ret=lcd_8bit_sned_command(my_lcd,0X0C);

        ret=lcd_8bit_sned_command(my_lcd,0X80);
